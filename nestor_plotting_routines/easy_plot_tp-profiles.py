...
names = ['hst', 'jwst', 'jwst-limbs']
files = ['./OUTPUT/hp41_wfc3_cc_two-hem.pic', './OUTPUT/hp41_wfc3_cc_jwst_two-hem.pic', './OUTPUT/hp41_wfc3_cc_jwst_two-limbs-cov.pic', '']
plot_corner = False
