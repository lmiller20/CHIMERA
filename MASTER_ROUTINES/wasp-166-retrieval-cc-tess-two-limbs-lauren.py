...
#pickle 
outpath="/user/lmiller/CHIMERA_results/OUTPUT_Lauren_new/wasp166_tess_cc_two-limbs-cov_new"
...
Tstar= 6086 #TICv8, Exoplanet Archive #Effective Temperature of the star in Kelvin
semiratio= 11.3 #Hellier et al. 2019 , Exoplanet Archive #Ratio of semi-major axis to stellar radius
f=2/3 
Ab=0 #Bond albedo
