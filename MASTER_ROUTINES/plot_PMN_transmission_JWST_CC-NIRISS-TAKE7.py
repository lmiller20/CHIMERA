...
#import run
pic=pickle.load(open('OUTPUT/pmn_transmission_jwst-FINAL-TAKE7-SOSS_cc.pic','rb'), encoding='latin1')
samples=pic[:,:-1]
lnprob=pic[:,-1]

outname='pmn_transmission_jwst-FINAL-TAKE7-SOSS_cc'
...
#chimera_toi199-2-sc-soss.datloading in data again just to be safe
