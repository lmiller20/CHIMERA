...
#pickle 
outpath="/user/lmiller/CHIMERA_results/OUTPUT_Lauren_new/wasp126_tess_cc_two-limbs-cov_new"
...
Tstar= 5800 #Pearson et al. 2019, Exoplanet Archive #Effective Temperature of the star in Kelvin
semiratio= 7.8870 #Pearson et al. 2019, Exoplanet Archive #Ratio of semi-major axis to stellar radius
f=2/3 
Ab=0 #Bond albedo
