...
outpath="./OUTPUT/pmn_transmission_jwst-FINAL-TAKE5-SOSS_cc"
...
def prior(cube,ndim,nparams):
    ...
    cube[8] = 7.*cube[8]-5.0  # quench pressure for Carbon and Oxygen compounds; form 10**(-5) to 10**(2) bars (i.e., 1 microbar down to 100 bars).
    cube[9] = 7.*cube[9]-5.0  # quench pressure for Nitrogen compounds; form 10**(-5) to 10**(2) bars (i.e., 1 microbar down to 100 bars).
