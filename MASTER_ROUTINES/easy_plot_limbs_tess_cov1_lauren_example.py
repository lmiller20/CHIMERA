...
pic=pickle.load(open('/user/lmiller/CHIMERA_results/OUTPUT_Lauren_new/wasp117_tess_cc_two-limbs-cov_new.pic','rb'), \
                encoding='latin1') #This is the directory you defined in the retrieval code as your output
...
if plot_corner:
    # Samples has...all the samples. In our case, shape [nsamples, 16]. Let's extract the common properties of the limbs and plot them in a corner plot:
...
if os.path.exists('model_wavelengths_tess-limbs-cov_wasp117_new.npy'):
    ...
    wavelengths_model = np.linspace(0.6, 3.0, 264) # This is defined by the user; essentially the HST, TESS, JWST wavelength space
