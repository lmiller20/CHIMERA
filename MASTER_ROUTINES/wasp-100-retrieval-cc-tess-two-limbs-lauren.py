...
#pickle 
outpath="/user/lmiller/CHIMERA_results/OUTPUT_Lauren_new/wasp100_tess_cc_two-limbs-cov_new"
...
Tstar= 6733.000 #TICv8, Exoplanet Archive #Effective Temperature of the star in Kelvin
semiratio= 4.93 #Stassun et al. 2017, Exoplanet Archive #Ratio of semi-major axis to stellar radius
f=2/3 
Ab=0 #Bond albedo
