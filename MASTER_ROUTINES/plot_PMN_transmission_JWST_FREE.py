...
#import run
pic=pickle.load(open('OUTPUT/TOI-199_transmission_jwst_free_NEW.pic','rb'), encoding='latin1')
samples=pic[:,:-1]
lnprob=pic[:,-1]

outname='pmn_transmission_jwst_freeNEW'
...
wlgrid, y_meas, err = np.loadtxt('chimera_toi199.dat',unpack=True)
